...
export default class ModalDropdown extends Component {
  ...
  _renderButton() {
    const {disabled, accessible, children, textStyle, renderButtonContent} = this.props;
    ...
    return (
      ...
      >
        {
          (renderButtonContent && renderButtonContent(buttonText, this.props)) ||
          children ||
          (
  ...
  _renderDropdown() {
    ...
    return (
      <FlatList scrollEnabled={scrollEnabled}
                ...
                ItemSeparatorComponent={(renderSeparator && renderSeparator()) || function() { return (<View style={styles.separator} />) }}
